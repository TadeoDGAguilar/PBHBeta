...
Downloadable Notebook with this example: {download}`Notebook 1 <https://github.com/TadeoDGAguilar/PBHBeta/blob/main/docs/notebooks/PBHBeta_(notebook).ipynb?raw=true>`
